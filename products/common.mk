...
ifdef NIGHTLY
    ...
    ifdef RELEASE
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.warped.version=Warped-AOSP-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC-$(shell date +%m%d%Y) \
            ro.modversion=Warped-AOSP-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(shell date +%m%d%Y)
    else
        PRODUCT_PROPERTY_OVERRIDES += \
